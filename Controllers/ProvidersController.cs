...
namespace OrderProcessingMVC.Controllers
{
    public class ProvidersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,OwnerId")] Provider provider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,OwnerId")] Provider provider)
        {
            if (id != provider.Id)
            {
                return NotFound();
